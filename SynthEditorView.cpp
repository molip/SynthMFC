...
BEGIN_MESSAGE_MAP(CSynthEditorView, CView)
	...
	ON_COMMAND_RANGE(ID_INSERT_MIDI, ID_INSERT_MULTIPLY, &CSynthEditorView::OnInsertModule)
...
void CSynthEditorView::OnInsertModule(UINT id)
{
	...
	const auto types = { "midi", "envl", "oscl", "pmix", "trgt", "filt", "math", "mixr", "pitc", "lfo", "dely", "arpe", "mult" };
